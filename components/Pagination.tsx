...
export const Pagination = () => {
  ...
  const initialPaginationCollection = Array.from(
    Array(numberOfPages).keys()
  ).map((n) => n + 1);
  const [paginationCollection, setPaginationCollection] = useState<Pagination>(
    initialPaginationCollection
  );
  ...
  const [displayNumbersOfPages, setDisplayNumbersOfPages] = useState(
    setNumber()
  );
      ...
      <div className="hidden md:-mt-px md:flex">
        <Link href={`/products/page/${displayNumbersOfPages[0]}`}>
          <a
            href="#"
            className={`${
              currentPage === displayNumbersOfPages[0]
                ? isActiveClass
                : inactiveClass
            }`}
          >
        ...
        <Link href={`/products/page/${displayNumbersOfPages[1]}`}>
          <a
            href="#"
            className={`${
              currentPage === displayNumbersOfPages[1]
                ? isActiveClass
                : inactiveClass
            }`}
            aria-current="page"
        ...
        <Link href={`/products/page/${displayNumbersOfPages[2]}`}>
          <a
            href="#"
            className={`${
              currentPage === displayNumbersOfPages[2]
                ? isActiveClass
                : inactiveClass
            }`}
          >
        ...
        <Link href={`/products/page/${displayNumbersOfPages[3]}`}>
          <a
            href="#"
            className={`${
              currentPage === displayNumbersOfPages[3]
                ? isActiveClass
                : inactiveClass
            }`}
          >
        ...
        <Link href={`/products/page/${displayNumbersOfPages[4]}`}>
          <a
            href="#"
            className={`${
              currentPage === displayNumbersOfPages[4]
                ? isActiveClass
                : inactiveClass
            }`}
          >
        ...
        <Link href={`/products/page/${displayNumbersOfPages[5]}`}>
          <a
            href="#"
            className={`${
              currentPage === displayNumbersOfPages[5]
                ? isActiveClass
                : inactiveClass
            }`}
          >
